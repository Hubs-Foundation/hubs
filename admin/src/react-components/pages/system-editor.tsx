      ...
      <Card classProp="mb-24">
        ...
        <div className="mb-40">
          ...
          <CardSection
            ...
            ctaCallback={() => {
              window.open(
                `https://hubs.mozilla.com/docs/hubs-cloud-asset-packs.html`
              );
            }}
                ...
                <div className="flex-box">
                  <div className="body-md">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      You&apos;re in the AWS SES Sandbox and people don&apos;t
                  ...
                  <div className="body-sm">
                    Users will not be able to log in until the system can send
                    email. You&apos;ll need to either{' '}
                    <a
                      href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/request-production-access.html"
                      target="_blank"
                      rel="noopener noreferrer"
            ...
            {exceededStorageQuota && (
              <div className="flex mb-12">
                ...
                <div className="flex-box">
                  ...
                  <div className="body-sm">
                    Visitors will not be able to upload new scenes, avatars, or
                    files until you increase the &apos;Storage Limit&apos; in
                    your stack settings.
                  </div>
                </div>
              </div>
            ...
            {needsAvatars && (
              <div className="flex mb-12">
                ...
                <div className="flex-box">
                  ...
                  <div className="body-sm">
                    Choose 'Import Content' on the left to load avatars.
                  </div>
                </div>
              </div>
            )}
            {needsScenes && (
              <div className="flex mb-12">
                ...
                <div className="flex-box">
                  ...
                  <div className="body-sm">
                    Choose 'Import Content' on the left to load scenes.
                  </div>
                </div>
              </div>
            )}
            {!isUsingCloudflare && (
              <div className="flex">
                ...
                <div className="flex-box">
                  ...
                  <div className="body-sm">
                    You can reduce costs and improve performance by using
                    Cloudflare's CDN to serve content. Choose 'Content CDN' on
        ...
        <div className="flex-align-items-center mb-20">
          ...
          <p className="body-md">
            ...
            <a
              className="link"
              rel="noopener noreferrer"
              href="https://discord.com/invite/sBMqSjCndj"
              target="_blank"
            >
