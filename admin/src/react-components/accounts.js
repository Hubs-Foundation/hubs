...
// RefreshWrapper that uses the modern useRefresh hook
const RefreshWrapper = ({ children, ...props }) => {
  const refresh = useRefresh();
  return React.cloneElement(children, { ...props, refresh });
};

// The main class component wrapped with styles
// The main class component wrapped with styles
const AccountListBase = withStyles(styles)(
  class AccountList extends Component {
    ...
    async onCreateAccount(e) {
      ...
      // Use the refresh function from props instead of refreshView
      this.props.refresh();
      // Quickfix snackbar component does not always close
      // Setting snackbar message to empty string closes
      this.clearCreateStatusTimer();
    ...
    render() {
      ...
      const { classes, refresh, ...other } = this.props;
      return (
        <>
...
// Export the component wrapped with the RefreshWrapper
export const AccountList = props => (
  <RefreshWrapper>
    <AccountListBase {...props} />
  </RefreshWrapper>
);
