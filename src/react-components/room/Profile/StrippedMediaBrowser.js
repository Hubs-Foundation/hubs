...
class StrippedMediaBrowser extends Component {
  static propTypes = {
  ...
  componentDidMount() {
    this.handleSourceClicked(SOURCES[1]);
    // this.handlePager(1);
  }
    ...
    return (
      ...
      this.props.mediaSearchStore.isFetching ||
        ...
        <>
          ...
          <MediaGrid isVariableWidth={false} sm={true}>
...
export default injectIntl(StrippedMediaBrowser);
