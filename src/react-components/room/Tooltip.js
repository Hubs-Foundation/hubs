...
function isStep(step, item) {
  // Defensive check: step may be undefined in testing/storybook environments
  // where the component is rendered without proper initialization
  return step && step.indexOf(item) !== -1;
}
