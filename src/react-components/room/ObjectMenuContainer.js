...
import { usePinObject, useRemoveObject, useGoToSelectedObject, getObjectUrl } from "./object-hooks";
import { ReactComponent as PinIcon } from "../icons/Pin.svg";
import { ReactComponent as LinkIcon } from "../icons/Link.svg";
import { ReactComponent as GoToIcon } from "../icons/GoTo.svg";
import { ReactComponent as DeleteIcon } from "../icons/Delete.svg";

export function ObjectMenuContainer({ hubChannel, scene }) {
  ...
  const { canGoTo, goToSelectedObject } = useGoToSelectedObject(scene);
  ...
  return (
    ...
    >
      ...
      <ObjectMenuButton as="a" href={getObjectUrl(activeObject)} target="_blank" rel="noopener noreferrer">
        <LinkIcon />
        <span>Link</span>
      </ObjectMenuButton>
      {canGoTo && (
