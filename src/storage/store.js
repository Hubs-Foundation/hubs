...
export default class Store extends EventTarget {
  constructor() {
    ...
    if (safeLocalStorage.getItem(LOCAL_STORE_KEY) === null) {
      safeLocalStorage.setItem(LOCAL_STORE_KEY, JSON.stringify({}));
    }
  ...
  get state() {
    if (!this.hasOwnProperty(STORE_STATE_CACHE_KEY)) {
      this[STORE_STATE_CACHE_KEY] = JSON.parse(safeLocalStorage.getItem(LOCAL_STORE_KEY));
    }
  ...
  update(newState, mergeOpts) {
    ...
    safeLocalStorage.setItem(LOCAL_STORE_KEY, JSON.stringify(finalState));
    delete this[STORE_STATE_CACHE_KEY];
