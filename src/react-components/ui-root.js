    ...
    const moreMenu = [
      {
        ...
        items: [
          ...
          {
            id: "user-profile",
            label: <FormattedMessage id="more-menu.profile" defaultMessage="�A�o�^�[�I��" />,
            icon: AvatarIcon,
      ...
      {
        id: "support",
        label: <FormattedMessage id="more-menu.support" defaultMessage="�T�|�[�g" />,
        items: [
          ...
          configs.feature("show_controls_link") && {
            id: "controls",
            label: <FormattedMessage id="more-menu.controls" defaultMessage="�����" />,
            icon: SupportIcon,
          ...
          configs.feature("show_terms") && {
            id: "tos",
            label: <FormattedMessage id="more-menu.tos" defaultMessage="�����p�K��" />,
                  ...
                  <>
                    {watching && (
                      <>
                        <ToolbarButton
                          icon={<EnterIcon />}
                          label={<FormattedMessage id="toolbar.join-room-button" defaultMessage="�߂�" />}
                          preset="accept"
                        ...
                        {/* {enableSpectateVRButton && (
                          <ToolbarButton
                            ...
                            preset="accent5"
                            label={
                              <FormattedMessage id="toolbar.spectate-in-vr-button" defaultMessage="���r�[���[�h" />
                            }
                    ...
                    {<ToolbarButton
                      icon={<LeaveIcon />}
                      label={<FormattedMessage id="toolbar.leave-room-button" defaultMessage="�ގ�" />}
                      preset="cancel"
                      onClick={() => {
                        this.showNonHistoriedDialog(LeaveRoomModal, {
                          destinationUrl: "/",
