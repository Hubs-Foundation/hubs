...
const XFORM_COLOR_1 = [150, 80, 150];
const XFORM_COLOR_2 = [23, 64, 118];
/**
...
AFRAME.registerComponent("cursor-controller", {
  ...
  tick: (() => {
    ...
    return function(t) {
      ...
      if (AFRAME.scenes[0].systems["xform-selected-object"].xforming) {
        _interpolateHSL(XFORM_COLOR_1, XFORM_COLOR_2, 0.5 + 0.5 * Math.sin(t / 1000.0), this.xformColor);
        this.color.setRGB(this.xformColor[0], this.xformColor[1], this.xformColor[2]);
