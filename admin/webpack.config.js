...
const threeExamplesDir = path.resolve(
  __dirname,
  'node_modules',
  'three',
  'examples'
);
const basisTranscoderPath = path.resolve(
  threeExamplesDir,
  'js',
  'libs',
  'basis',
...
const dracoWasmWrapperPath = path.resolve(
  threeExamplesDir,
  'js',
  'libs',
  'draco',
...
const basisWasmPath = path.resolve(
  threeExamplesDir,
  'js',
  'libs',
  'basis',
...
const dracoWasmPath = path.resolve(
  threeExamplesDir,
  'js',
  'libs',
  'draco',
        ...
        },
        {
          ...
          exclude: function (modulePath) {
            return (
              ...
              !/node_modules\/hubs/.test(modulePath)
            );
          },
        },
        {
