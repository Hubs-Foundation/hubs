...
export async function getAvailableVREntryTypes() {
  ...
  const screen = isInVR ? VR_DEVICE_AVAILABILITY.no : VR_DEVICE_AVAILABILITY.yes;
  ...
  let daydream =
    isMaybeDaydreamCompatibleDevice() && !isInVR ? VR_DEVICE_AVAILABILITY.maybe : VR_DEVICE_AVAILABILITY.no;
  ...
  return { screen, generic, gearvr, daydream, cardboard, isInVR };
}
