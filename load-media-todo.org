...
**** DONE Fix issue where we can't move videos
*** TODO AUDIO
*** DONE IMAGE
*** TODO PDF
*** DONE MODEL
...
** DONE Restore original pasting action.
** DONE Support pasting files
** DONE Put it behind a feature flag
...
Both work, but no way to spawn 360 images yet.
...
** TODO Pinning
** DONE Do memory audit. What is our footprint?
Each entity seems to be about 1.2 KB. 10000 entities ~ 120MB.
** DONE Fix scale animate hover thing
Not sure if this is fixed, but can't reproduce
** DONE Check that the play/pause video behavior we added for new videos did not mess up aframe videos
